...
def build_vgg16(input_shape, num_classes):
    # Menggunakan VGG16 tanpa weights pre-trained (training dari awal) atau bisa juga menggunakan weights='imagenet'
...
def main():
    ...
    model = build_vgg16(input_shape=(112, 112, 3), num_classes=num_classes)
    ...
    plt.tight_layout()
    plt.savefig('vgg16_loss_acc.png')
    plt.show()
